...
function Nav() {
  ...
  return (
    <div className='w-full h-[80px] flex items-center justify-between md:justify-center gap-[30px] px-[20px] fixed top-0 z-[9999] bg-[#fff9f6] overflow-visible'>
      ...
      {/* 🏠 Logo */}
      <h1 className='text-3xl font-bold mb-2 text-[#ff4d2d] cursor-pointer' onClick={() => navigate("/")}>Zingo</h1>
      ...
      <div className='flex items-center gap-4'>
        ...
        {userData.role == "owner" ? (
          ...
          <>
            ...
            <button
              className='hidden md:block px-3 py-1 rounded-lg bg-green-100 text-green-700 text-sm font-semibold hover:bg-green-200 transition'
              onClick={() => navigate("/collaboration")}
            >
              Collaboration
            </button>

            {/* 🆕 Collaboration icon for mobile */}
            <button
        ...
        {showInfo && (
          ...
          >
            ...
            {/* 🆕 Added Collaboration shortcut inside dropdown (mobile users) */}
            {userData.role == "user" && (
              <div className='text-green-600 font-semibold cursor-pointer' onClick={() => navigate("/collaboration")}>
                Collaboration
              </div>
            )}
